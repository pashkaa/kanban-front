...
export const Task: React.FC<TaskBodyType> = ({_id, title, description, boardId, droppableId}) => {
    ...
    return (
        <div className={s.taskContainer} >
            ...
            <Buttons disabled={!isReady} _id={_id} title={title} description={description} droppableId={droppableId} boardId={boardId} changeIsGood={changeIsGood}/>
        </div>
    )
}